:Title: Release Notes for OGC Two Dimensional Tile Matrix Set and Tile Set Metadata v.2.0
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Reference URL for this OGC(R) document: http://www.opengis.net/doc/{doc-type}/{standard}/{m.n}
|Internal reference number of this OGC(R) document:    21-066r1
...
include::clause-7-administrative.adoc[]

include::clause-8-future.adoc[]

////
add major sections (clauses) as necessary
////

//include::clause-8-topic.adoc[]
//include::clause-9-topic.adoc[]
