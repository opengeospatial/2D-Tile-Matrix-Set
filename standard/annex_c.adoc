...
tables (or their implied extensions). Note that the correspondance between the numeric identifiers of a TileMatrixSet and those of a WKSS might be offset
