...
Despite that was commented in <<TileMatrixSetCRSCompatibility>>, some implementers prefer to define the previous TileMatrixSet using the CRS http://www.opengis.net/def/crs/EPSG/0/4326.
