...
image::figures/11.png[Tile Matrix Id 1 (2x1 tiles) of the WorldCRS84Quad TileMatrixSet (Source: INSPIRE technical guidance)]
...
Despite what is stated in <<TileMatrixSetCRSCompatibility>>, some implementers prefer to define the previous TileMatrixSet using the CRS http://www.opengis.net/def/crs/EPSG/0/4326.
