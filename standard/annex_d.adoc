...
NOTE: Please note that the EPSG:3035 is defined as: "Cartesian 2D CS. Axes: northing, easting (Y,X). Orientations: north, east. UoM: m". Be aware the axis order is not (X,Y).
