...
For the CDB Global Grid, the polar adjustment zones corresponding to coalescence factors are the same (at a given latitude) for all tile matrices of the set.
