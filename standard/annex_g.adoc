...
[source,json]
....
include::../schemas/tms/2.0/json/examples/tilematrixset/GNOSISGlobalGrid.json[lines=1..180]
      }
   ]
}
....
...
[source,xml]
....
include::../schemas/tms/2.0/xml/examples/tilematrixset/GNOSISGlobalGrid.xml[lines=1..160]
</TileMatrixSet>
....
...
include::../schemas/tms/2.0/json/examples/tilematrixset/CDBGlobalGrid.json[lines=593..786]
      }
   ]
}
....
...
include::../schemas/tms/2.0/xml/examples/tilematrixset/CDBGlobalGrid.xml[lines=550..729]
</TileMatrixSet>
....
 