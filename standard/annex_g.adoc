...
[source,json]
....
include::../schemas/tms/2.0/json/examples/tilematrixset/GNOSISGlobalGrid.json[lines=1..184]
      }
   ]
}
....
...
[source,json]
....
include::../schemas/tms/2.0/json/examples/tilematrixset/CDBGlobalGrid.json[lines=1..11]
include::../schemas/tms/2.0/json/examples/tilematrixset/CDBGlobalGrid.json[lines=597..790]
      }
   ]
}
....
