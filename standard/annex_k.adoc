...
This way, opening up a tile from anywhere in the world in a 3D model viewer or editor buildings for example would always appear properly oriented upwards.
