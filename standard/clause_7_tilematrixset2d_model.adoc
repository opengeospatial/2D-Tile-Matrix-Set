...
Style | Style used to generate the layer in the tileset | Style data structure, see <<parts-of-style-data-structure>> | Zero or one (optional)
...
PropertiesSchema | properties represented by the features in this layer | FeatureAttribute data structure. See <<parts-of-feature-attribute-data-structure>> | Zero or more (optional)
