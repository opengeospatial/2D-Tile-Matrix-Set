...
include::requirements/REQ_json_tilematrixset2d.adoc[]
...
include::requirements/requirements-json-variablematrixwidth.adoc[]
...
include::requirements/requirements-xml-tilematrixset2d.adoc[]
...
include::requirements/requirements-xml-variablematrixwidth.adoc[]
