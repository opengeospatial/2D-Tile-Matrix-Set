...
| tileMatrix‌SetURI | Reference to an official source for this tileMatrixSet | URI type^b^ | Zero or One (optional) Include if this is one of the OGC NA TileMatrixSets
