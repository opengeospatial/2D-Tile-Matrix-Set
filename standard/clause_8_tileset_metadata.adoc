...
^a^ As specified in ISO 19107. The CRS and order of these coordinates shall be as specified by the _crs_.

^b^ If unspecified, the default value is the CRS of the Tileset, and if none specified, the CRS of the TileMatrixSet.
