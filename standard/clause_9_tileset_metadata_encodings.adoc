...
include::requirements/requirements_json-tilematrixsetlimits2d.adoc[]

include::requirements/json-tilematrixsetlimits2d/REQ_json_tilematrixsetlimits2d_model.adoc[]

include::requirements/json-tilematrixsetlimits2d/REQ_json_tilematrixsetlimits2d_ietf.adoc[]

include::requirements/json-tilematrixsetlimits2d/REQ_json_tilematrixsetlimits2d_schema.adoc[]
...
<<example-encodings-for-tilesetmetadata-informative>> provides JSON examples for common TileMatrixSetLimits2D.
...
include::requirements/requirements_xml-tilematrixsetlimits2d.adoc[]

include::requirements/xml-tilematrixsetlimits2d/REQ_xml_tilematrixsetlimits2d_model.adoc[]

include::requirements/xml-tilematrixsetlimits2d/REQ_xml_tilematrixsetlimits2d_schema.adoc[]
...
<<example-encodings-for-tilesetmetadata-informative>> provides XML examples encoding TileMatrixSetLimits2D.
