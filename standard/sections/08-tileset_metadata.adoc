...
tileset, tiles that cover the same bounding box than the previous tileset
...
TileMatrixSet that covers a bigger area (or even global one, such as one of
defined in <<annex-common-tilematrixset-definitions-informative>>). In fact,
