...
include::clause_6_tile_matrix_set_concept.adoc[]

include::clause_7_tilematrixset2d_model.adoc[]

include::clause_8_xml_encoding.adoc[]

include::clause_9_json_encoding.adoc[]
